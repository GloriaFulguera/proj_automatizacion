...
//			WebElement a = spans.get(1);
			
//			WebElement a = driver.findElement(By.cssSelector("span[class='wpcf7-not-valid-tip']"));
//			WebElement a = driver.findElement(By.css("span[class='wpcf7-not-valid-tip']"));
			
			assertTrue(spans.get(1).isDisplayed());
